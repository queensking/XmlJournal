...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
  ...
  <!--获取所有的h2节点集合-->
  <xsl:variable name="h2Para" select="//w:p[w:pPr/w:pStyle[@w:val='2']]"/>

  <!--获取所有的H3节点和H2节点的并集-->
  <xsl:variable name="H3AndH2" select="$h3Para | $h2Para"/>
              ...
              <section xmlns="" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:meta="http://www.springer.com/app/meta" class="Section1 RenderAsSection1 SectionTypeMaterialsAndMethods" id="Bib1">
                ...
                <div class="js-CollapseSection">
                  <ol class="BibliographyWrapper">
                    <xsl:apply-templates select="//w:p[w:bookmarkStart[starts-with(@w:name,'_Ref')]]"/>
                  </ol>
                </div>
              </section>
  ...
  <xsl:template name="abstractPart">
    ...
    <!--<xsl:variable name="abstractNode" select="/w:body/w:p[w:pPr/w:pStyle[@w:val='2']][w:r/w:t='Abstract']"/>-->
  ...
  <!--****************************************************Abstract之下的内容 H3以及H3下面的普通段落的组合  被1使用了****************************************************-->
  <!--获取在Abstract下方的H3-->
  ...
  <!--将论文中的引用转成html-->
  <xsl:template match="//w:p[w:bookmarkStart[starts-with(@w:name,'_Ref')]]">
